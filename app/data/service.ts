...
export const SERVICES: ServiceItem[] = [
  {
    ...
    desc: `Realizamos instalação de ar-condicionado comercial na Zona Sul de São Paulo, com soluções sob medida para lojas, escritórios, restaurantes e indústrias. O serviço inclui análise técnica, instalação elétrica, fixação segura e testes de performance. Garantimos eficiência energética e climatização uniforme em grandes ambientes`,
  },
  {
    slug: "manutencao-ar-condicionado",
    label: "Manutenção de ar-condicionado",
    img: "/imgs/servicos/manutencao-ar.webp",
    desc: ` Problemas no ar-condicionado K7, como falhas no resfriamento ou ruídos, exigem diagnóstico técnico especializado. Na Zona Sul, realizamos conserto e revisão completa de sistemas Cassete (K7), verificando componentes elétricos, gás refrigerante e sensores de temperatura. Restauramos o funcionamento ideal do equipamento para ambientes comerciais e corporativos.`,
  },
  {
    slug: "instalacao-camara-fria",
    label: "Instalação de câmaras frias e Frigorifica",
    img: "/imgs/servicos/instalacao-camara.webp",
    desc: ` Precisando instalar uma câmara frigorífica na Zona Sul? Realizamos projeto, instalação elétrica, isolamento térmico, teste de funcionamento e entrega técnica completa. Atendemos indústrias, supermercados, restaurantes e qualquer negócio que necessite de ambiente refrigerado dedicado. A execução técnica inclui tudo para funcionamento seguro e eficiente.`,
  },
  {
    slug: "manutencao-camara-fria",
    label: "Manutenção Câmara Fria e Frigorifica",
    img: "/imgs/servicos/manutencao-camara.webp",
    desc: ` A manutenção de câmara fria exige cuidado especializado: vedações, sistema de refrigeração, carga de gás, limpeza de tubulações. Na Zona Sul de São Paulo nossas equipes atuam com rotina preventiva e corretiva para garantir que seu ambiente siga estável, com temperatura ideal e sem falhas. Ideal para operações que dependem de conservação rigorosa.`,
  },
  {
